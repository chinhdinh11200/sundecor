                ...
                <div class="card">
                    ...
                    <form action="" class="card-option">
                        <select name="" id="" class="form-control" area onchange="window.location=this.value">
                            <option value="{{ route('admin.gift.index') }}">---- Chọn trạng thái ----</option>
                            <option value="{{ route('admin.gift.classify', 0) }}" {{ $type == 0 ? 'selected' : '' }}>Chưa liên hệ</option>
                            <option value="{{ route('admin.gift.classify', 1) }}" {{ $type == 1 ? 'selected' : '' }}>Đã liên hệ</option>
                        </select>
                    </form>
                    <div class="card-body">
